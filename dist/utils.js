...
export var getRotationDegrees = function (prizeNumber, numberOfPrizes, randomDif) {
    ...
    var imperfectRotation = degreesPerPrize * (numberOfPrizes - prizeNumber) - initialRotation + randomDifference;
...
export var getQuantity = function (prizeMap) { return prizeMap.slice(-1)[0].slice(-1)[0] + 1; };
